...
fit_knn <- caret::train(Transported ~ GroupId + HomePlanet + CryoSleep + DeckNum  + Side + Destination + Age + Expenditure,
                 method = "knn",
                 trControl = control,
...
```{r}
fit_lr <- caret::train(Transported ~ GroupId + HomePlanet + CryoSleep + DeckNum  + Side + Destination + Age + Expenditure,
                method = "glm",
                trControl = control,
                data = space_titanic_train)
...
lasso <- caret::train(Transported ~ GroupId + HomePlanet + CryoSleep + DeckNum + Side + Destination + Age + Expenditure,
             data = space_titanic_train,
             method = 'glmnet', 
...
ridge <- caret::train(Transported ~ GroupId + HomePlanet + CryoSleep + DeckNum + Side + Destination + Age + Expenditure,
             data = space_titanic_train,
             method = 'glmnet', 
...
```{r}
train_log <- caret::train(Transported ~ GroupId + HomePlanet + CryoSleep + DeckNum  + Side + Destination + Age + Expenditure, 
                   method = "glm",
                   data=space_titanic_train)
...
```{r}
train_svm_lin <- caret::train(Transported ~ GroupId + HomePlanet + CryoSleep + 
                         DeckNum  + Side + Destination + Age + Expenditure,
                       method = "svmLinear", 
                       trControl = tr_control,  
                       data = space_titanic_train,
...
```{r}
train_svm_poly <- caret::train(Transported ~ GroupId + HomePlanet + CryoSleep + DeckNum  + Side + Destination + Age + Expenditure ,
                        method = "svmPoly",
                        trControl = tr_control,
                        data = space_titanic_train,
                        preProcess = c("center","scale"),
